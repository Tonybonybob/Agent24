...
import AgentReferals from './AgentReferals';
      ...
      <GeneralLayout>
        ...
        <div className="agentProfile">
          ...
          <div className="agentProfile__content">
            ...
            <Route path={`${match.url}/services`} component={AgentServices} />
            <Route path={`${match.url}/payments`} component={AgentPayments} />
            <Route path={`${match.url}/referals`} component={AgentReferals} />
          </div>
        </div>
      </GeneralLayout>
    );
